      ...
      <div className="main-container">
        <div className="left-container">
          ...
          <div className="left-play-settings">
            <img src="/public/play-back.svg" alt="Play back button" />
            <img src="/public/play.svg" alt="Play button" />
            <img src="/public/play-forward.svg" alt="Play forward button" />
          </div>
